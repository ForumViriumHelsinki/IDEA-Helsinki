...
def validate_disturbance_dates(
    ...
    if len(validated_disturbances):
        new_disturbance_data = {
            k: v for k, v in disturbance_data.items() if k != "features"
        }
